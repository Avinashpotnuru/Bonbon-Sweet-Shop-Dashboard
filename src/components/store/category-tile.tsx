  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className={cn(
          "absolute inset-0 -z-10 bg-gradient-to-br transition-transform duration-700 ease-out group-hover:scale-[1.06]",
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-10 -top-12 -z-10 size-44 rounded-full bg-white/20 blur-2xl transition-transform duration-700 group-hover:scale-150"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-14 -left-10 -z-10 size-44 rounded-full bg-black/15 blur-2xl"
      />
      {/* Floating monogram */}
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -right-3 -top-6 -z-10 select-none font-heading text-[5rem] font-bold leading-none text-white/20"
      >
        {monogram}
      </span>

      {/* Top: count badge */}
      <span className="inline-flex w-fit items-center rounded-full bg-white/20 px-2.5 py-1 text-[0.7rem] font-medium backdrop-blur-sm ring-1 ring-white/25">
